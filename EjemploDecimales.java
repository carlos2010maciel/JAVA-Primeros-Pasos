...
public class EjemploDecimales {
	...
	public static void main(String[] args) {
		...
		double edad = 28; // Números enteros si pueden ser asignados a variables tipo double
		double salarioMitad = salario / 2;
		System.out.println(salarioMitad); // Podemos usar variables directamente en operaciones matemáticas
