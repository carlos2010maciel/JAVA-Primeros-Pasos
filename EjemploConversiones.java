...
public class EjemploConversiones {
	...
	public static void main(String[] args) {
		...
		// int prueba = 122222222222222222; No compila porque el número esta fuera del rango aceptado por int
		long prueba = 122222222222222222L; // Se especifica con L para asignar valor a una variable tipo long
